          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                margin:
                    EdgeInsets.fromLTRB(31 * fem, 0 * fem, 0 * fem, 30 * fem),
                child: Text(
                  ' Checklist Tracking',
              ...
              Container(
                // frame8wQP (292:62)
                margin:
                    EdgeInsets.fromLTRB(31 * fem, 0 * fem, 70 * fem, 43 * fem),
                width: double.infinity,
                child: Column(
                      ...
                      child: Stack(
                        children: [
                          Positioned(
                            ...
                            top: 0 * fem,
                            child: Container(
                              padding: EdgeInsets.fromLTRB(257.7 * fem,
                                  25.09 * fem, 28.3 * fem, 22.63 * fem),
                              width: 327 * fem,
                              height: 64 * fem,
                              decoration: BoxDecoration(
                                color: Color(0xff042745),
