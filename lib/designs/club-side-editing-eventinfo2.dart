...
class Editing2 extends StatefulWidget {
  static const String screenRoute = 'Event_edit_screen2';

  @override
  _Editing2State createState() => _Editing2State();
}

class _Editing2State extends State<Editing2> {
