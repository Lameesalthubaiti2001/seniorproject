    ...
    return Container(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Container(
              // autogroupp2116ZR (7P5x7pLtZVRxn9vMNkp211)
            ...
            Container(
              // successfullyKj1 (270:1342)
              margin: EdgeInsets.fromLTRB(38*fem, 0*fem, 30*fem, 118*fem),
              padding: EdgeInsets.fromLTRB(78*fem, 40*fem, 59*fem, 130*fem),
              width: double.infinity,
              decoration: BoxDecoration (
              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    margin: EdgeInsets.fromLTRB(14*fem, 0*fem, 39*fem, 8*fem),
                    width: double.infinity,
                    height: 63*fem,
                    child: Row(
                      crossAxisAlignment: CrossAxisAlignment.center,
