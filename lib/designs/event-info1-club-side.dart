        ...
        child: Column(
          ...
          children: [
              ...
              child: Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    margin: EdgeInsets.fromLTRB(
                        0 * fem, 0 * fem, 4.99 * fem, 48.08 * fem),
                    width: 16.95 * fem,
                    height: 10.67 * fem,
                    child: Image.asset(
                  ...
                  Container(
                    // wifiY6P (254:35)
                    margin: EdgeInsets.fromLTRB(
                        0 * fem, 0 * fem, 4.88 * fem, 47.75 * fem),
                    width: 15.29 * fem,
                    height: 11 * fem,
                    child: Image.asset(
            ...
            Container(
              ...
              padding:
                  EdgeInsets.fromLTRB(6 * fem, 16 * fem, 0 * fem, 9.4 * fem),
              width: double.infinity,
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Container(
                    ...
                    margin: EdgeInsets.fromLTRB(
                        2 * fem, 0 * fem, 0 * fem, 190 * fem),
                    padding: EdgeInsets.fromLTRB(
                        16 * fem, 33 * fem, 16 * fem, 71 * fem),
                    width: 378 * fem,
                    decoration: BoxDecoration(
